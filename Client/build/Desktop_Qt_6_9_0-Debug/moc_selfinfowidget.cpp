...
namespace {
struct qt_meta_tag_ZN14SelfInfoWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto SelfInfoWidget::qt_create_metaobjectdata<qt_meta_tag_ZN14SelfInfoWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SelfInfoWidget, qt_meta_tag_ZN14SelfInfoWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject SelfInfoWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14SelfInfoWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14SelfInfoWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14SelfInfoWidgetE_t>.metaTypes,
    nullptr
} };
...
void *SelfInfoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14SelfInfoWidgetE_t>.strings))
