...
public:
    ...
    void setupUi(QWidget *SelfInfoWidget)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/src/\344\270\252\344\272\272\344\270\255\345\277\203\347\273\277.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        icon1.addFile(QString::fromUtf8(":/src/dz1.png"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
...
"}"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/pic/src/close.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
