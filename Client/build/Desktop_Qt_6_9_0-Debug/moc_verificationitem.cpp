...
namespace {
struct qt_meta_tag_ZN16VerificationItemE_t {};
} // unnamed namespace

template <> constexpr inline auto VerificationItem::qt_create_metaobjectdata<qt_meta_tag_ZN16VerificationItemE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<VerificationItem, qt_meta_tag_ZN16VerificationItemE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject VerificationItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16VerificationItemE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16VerificationItemE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16VerificationItemE_t>.metaTypes,
    nullptr
} };
...
void *VerificationItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16VerificationItemE_t>.strings))
