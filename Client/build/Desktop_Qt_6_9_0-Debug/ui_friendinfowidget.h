...
public:
    ...
    void setupUi(QWidget *FriendInfoWidget)
    {
        ...
        label_name->setCursor(QCursor(Qt::CursorShape::IBeamCursor));
        ...
        textEdit_sig->viewport()->setProperty("cursor", QVariant(QCursor(Qt::CursorShape::IBeamCursor)));
        ...
        label_account->setCursor(QCursor(Qt::CursorShape::IBeamCursor));
